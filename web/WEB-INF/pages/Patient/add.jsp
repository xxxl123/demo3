...
<div class="content">
    ...
    <div class="header">
        ...
        <h1 class="page-title">添加病人</h1>
    </div>

    <ul class="breadcrumb">
        <li><a href="#">病人信息管理</a> <span class="divider">/</span></li>
        <li class="active">添加病人</li>
    </ul>
            ...
            <div class="row-fluid">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <form id="tab" action="${pageContext.request.contextPath}/Patientadd" method="post">
                            <label>病人姓名</label>
                            <select class="input-xlarge" name="name" data-edit-select="1" onmousedown="if(this.options.length>3){this.size=8}"
                                    onblur="this.size=0" onchange="this.size=0" style="position:absolute;z-index:1; width: 284px">
                                <c:forEach var="v" items="${list}">
                                    <option value="${v.name}">${v.name}--------------${v.idcard}</option>
                                </c:forEach>
                            </select>
                            <br>
                            <br>
                            <label>生日</label>
                            <input type="date" class="input-xlarge" name="birthday" required>
                            ...
                            <label>职业</label>
                            <input type="text" class="input-xlarge" name="career" required>
                            <label>家庭地址</label>
                            <input type="text" class="input-xlarge" name="address" required>
                            <label>手机号</label>
                            <input type="text" class="input-xlarge" name="mobile" required>
                            <label>身份证号</label>
                            <input type="text" class="input-xlarge" name="idcard" required>
                            <label>系统登录账号</label>

                            <input type="text" class="input-xlarge" name="username" required>
                            <label>系统登录密码</label>
