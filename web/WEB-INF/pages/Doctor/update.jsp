            ...
            <div class="row-fluid">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <form id="tab" action="${pageContext.request.contextPath}/Doctorupdate" method="post">
                            <label>医生姓名</label>
                            ...
                            <label>科室</label>
                            <input type="text" class="input-xlarge" name="dep" value="${v.dep}" required>
                            <label>家庭地址</label>
