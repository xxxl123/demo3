...
<div class="content">
    ...
    <div class="header">
        ...
        <h1 class="page-title">添加病人处方</h1>
    </div>

    <ul class="breadcrumb">
        <li><a href="#">病人处方信息管理</a> <span class="divider">/</span></li>
        <li class="active">添加病人处方</li>
    </ul>
            ...
            <div class="row-fluid">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <form id="tab" action="${pageContext.request.contextPath}/Prescriptionadd" method="post">

                            <label>选择病人</label>
                            <select class="input-xlarge" name="patientid">
                            ...
                            <label>门诊号或住院号</label>
                            <input type="text" class="input-xlarge" name="inpatientnumber" required>


                            <label>处方内容</label>
                            <textarea rows="6" cols="60" class="input-xlarge" name="content" required></textarea>
