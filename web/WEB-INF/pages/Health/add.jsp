...
<div class="content">
    ...
    <div class="header">
        ...
        <h1 class="page-title">添加社区居民身体状况</h1>
    </div>

    <ul class="breadcrumb">
        <li><a href="#">社区居民身体状况信息管理</a> <span class="divider">/</span></li>
        <li class="active">添加社区居民身体状况</li>
    </ul>
            ...
            <div class="row-fluid">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <form id="tab" action="${pageContext.request.contextPath}/Healthadd" method="post">

                            <label>选择居民</label>
                            <select class="input-xlarge" name="userid" data-edit-select="1" onmousedown="if(this.options.length>3){this.size=8}"
                                    onblur="this.size=0" onchange="this.size=0" style="position:absolute;z-index:1; width: 271px">
                                <c:forEach var="v" items="${list}">
                                    <option value="${v.id}">${v.name}--------------${v.idcard}</option>
                                </c:forEach>
                            </select>
                            <br>
                            <br>
