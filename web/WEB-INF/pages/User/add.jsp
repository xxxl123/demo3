...
<div class="content">
    ...
    <div class="header">
        ...
        <h1 class="page-title">添加社区居民</h1>
    </div>

    <ul class="breadcrumb">
        <li><a href="#">社区居民信息管理</a> <span class="divider">/</span></li>
        <li class="active">添加社区居民</li>
    </ul>
            ...
            <div class="row-fluid">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <form id="tab" action="${pageContext.request.contextPath}/Useradd" method="post">
                            <label>居民姓名</label>
                            <input type="text" class="input-xlarge" name="name" required>
                            <label>居民身份证号</label>
                            <input type="text" class="input-xlarge" name="idcard" required>
                            <label>居民年龄</label>
                            <input type="int" class="input-xlarge" name="age" required>
                            <label>手机号</label>
                            <input type="text" class="input-xlarge" name="phone" required>
                            <br/>
                            <input type="submit" value="添加" class="btn btn-success" onclick="disp_alert()">
                        </form>
                    </div>
