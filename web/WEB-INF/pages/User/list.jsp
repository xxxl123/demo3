...
<div class="content">
    ...
    <div class="header">
        ...
        <h1 class="page-title">查看社区居民</h1>
    </div>

    <ul class="breadcrumb">
        <li><a href="#">社区居民管理</a> <span class="divider">/</span></li>
        <li class="active">查看社区居民</li>
    </ul>
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="row-fluid">
                        ...
                        <tr>
                            ...
                            <td>
                                <a type="button" class="btn btn-info"
                                   href="${pageContext.request.contextPath}/Usertoupdate?id=${v.id}">编辑</a>
                                <a type="button" class="btn btn-danger"
                                   href="${pageContext.request.contextPath}/Userdel?id=${v.id}"
                                   onclick="return  confirm('确定删除此居民吗');">删除</a>
                            </td>
                ...
                <ul class="pagination">
                    <li><a href="#">«</a></li>
                    <li><a href="${pageContext.request.contextPath}/Userlist">1</a></li>
                    <li><a class="active" href="${pageContext.request.contextPath}/UserlistbyId?id=2">2</a></li>
                    <li><a href="${pageContext.request.contextPath}/UserlistbyId?id=3">3</a></li>
                    <li><a href="${pageContext.request.contextPath}/UserlistbyId?id=4">4</a></li>
                    <li><a href="${pageContext.request.contextPath}/UserlistbyId?id=5">5</a></li>
                    <li><a href="${pageContext.request.contextPath}/UserlistbyId?id=6">6</a></li>
                    <li><a href="${pageContext.request.contextPath}/UserlistbyId?id=7">7</a></li>
                    <li><a href="#">»</a></li>
                </ul>
            </div>
        </div>
