...
<div class="content">
    ...
    <div class="header">
        ...
        <h1 class="page-title">查看病人</h1>
    </div>

    <ul class="breadcrumb">
        <li><a href="#">病人管理</a> <span class="divider">/</span></li>
        <li class="active">查看病人</li>
    </ul>
    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="row-fluid">
                        ...
                        <tr>
                            ...
                            <td>
                                <a type="button" class="btn btn-info"
                                   href="${pageContext.request.contextPath}/Patienttoupdate?id=${v.id}">编辑</a>
                                <a type="button" class="btn btn-danger"
                                   href="${pageContext.request.contextPath}/Patientdel?id=${v.id}"
                                   onclick="return  confirm('确定删除此病人吗');">删除</a>
                            </td>
                ...
                <ul class="pagination">
                    <li><a href="#">«</a></li>
                    <li><a href="${pageContext.request.contextPath}/Patientlist">1</a></li>
                    <li><a class="active" href="${pageContext.request.contextPath}/PatientlistbyId?id=2">2</a></li>
                    <li><a href="${pageContext.request.contextPath}/PatientlistbyId?id=3">3</a></li>
                    <li><a href="${pageContext.request.contextPath}/PatientlistbyId?id=4">4</a></li>
                    <li><a href="${pageContext.request.contextPath}/PatientlistbyId?id=5">5</a></li>
                    <li><a href="${pageContext.request.contextPath}/PatientlistbyId?id=6">6</a></li>
                    <li><a href="${pageContext.request.contextPath}/PatientlistbyId?id=7">7</a></li>
                    <li><a href="#">»</a></li>
                </ul>
            </div>
        </div>
