...
<div class="content">
    ...
    <div class="header">
        ...
        <h1 class="page-title">修改社区居民</h1>
    </div>

    <ul class="breadcrumb">
        <li><a href="#">社区居民信息管理</a> <span class="divider">/</span></li>
        <li class="active">修改社区居民</li>
    </ul>
            ...
            <div class="row-fluid">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <form id="tab" action="${pageContext.request.contextPath}/Userupdate" method="post">
                            <label>居民姓名</label>
                            <input type="text" class="input-xlarge" name="name" value="${v.name}" required>

                            <label>居民身份证号</label>
                            <input type="text" class="input-xlarge" name="idcard" value="${v.idcard}" required>


                            <label>居民年龄</label>
                            <input type="int" class="input-xlarge" name="age" value="${v.age}" required>

                            <input type="hidden" name="id" value="${v.id}"/>

                            <label>手机号</label>
                            <input type="text" class="input-xlarge" name="phone" value="${v.phone}" required>
